...
// <View>
// <TextInput placeholder="enter your name" onChangeText={(name) => this.setState({ username: name })} style={{ borderWidth: 1 }} />
// <TextInput placeholder="enter your password" style={{ borderWidth: 1 }} onChangeText={(pass) => this.setState({ password: pass })} />
// <Button title="login" onPress={this.logIn} />
// </View>
// <View>
// <TextInput placeholder="login name" onChangeText={(name) => {
//     this.setState({ username: name }, () => console.log(this.state.username))

// }} style={{ borderWidth: 1, borderColor: 'red' }} />
// <TextInput placeholder="login password" style={{ borderWidth: 1, borderColor: 'red' }} onChangeText={(pass) => this.setState({ password: pass })} />
// <Button title="Checklogin" onPress={this.checkLogIn} />
// </View>
